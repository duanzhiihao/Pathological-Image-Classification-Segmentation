...
def train(network, X, Y):
    # Training
    model = tflearn.DNN(network, checkpoint_path='model_googleV3/model_100X',
                        max_checkpoints=10, tensorboard_verbose=0, tensorboard_dir='tflearn_logs')
    model.fit(X, Y, n_epoch=500, validation_set=0.1, shuffle=True,
              show_metric=True, batch_size=64, snapshot_step=1000,
              snapshot_epoch=False, run_id='googleV3net_BreaKHis')
...
if __name__ == '__main__':
    ...
    X, Y = load_data('BreaKHis100X.txt', 2)
